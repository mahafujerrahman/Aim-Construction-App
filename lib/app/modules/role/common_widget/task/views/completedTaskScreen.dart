...
class ProjectCompletedTaskScreen extends StatefulWidget {
  ProjectCompletedTaskScreen({super.key});

  @override
  State<ProjectCompletedTaskScreen> createState() => _ProjectCompletedTaskScreenState();
}

class _ProjectCompletedTaskScreenState extends State<ProjectCompletedTaskScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (projectId != null) {
        projectTaskController.getAllProjectTaskDetails(task_status: 'complete', projectId: projectId!);
      }
    });
