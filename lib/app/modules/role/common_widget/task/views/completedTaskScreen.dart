...
class ProjectrCompletedTaskScreen extends StatefulWidget {
  ProjectrCompletedTaskScreen({super.key});

  @override
  State<ProjectrCompletedTaskScreen> createState() => _ProjectrCompletedTaskScreenState();
}

class _ProjectrCompletedTaskScreenState extends State<ProjectrCompletedTaskScreen> {
